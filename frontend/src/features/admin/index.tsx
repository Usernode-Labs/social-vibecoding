          ...
          <div className="flex-1 min-w-0">
            ...
            */}
            <div
              ...
              className="hidden bg-amber-50 dark:bg-transparent border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-200 rounded-lg px-4 py-3 mb-4 text-sm"
            >
        ...
        <div id="admin-temp-pw-modal" className={`hidden ${AdminUI.dialogOverlay}`}>
          <div className={AdminUI.dialogPanel}>
            ...
            <p className={`${AdminUI.muted} mb-4`}>
              Give this to <span id="admin-temp-pw-username" className="font-medium text-zinc-800 dark:text-zinc-200"></span> out-of-band (chat, in person). They use it as their password to log in, then set their own from <a href="#settings/password" className="text-azure-700 hover:text-azure-800 dark:text-azure-300 dark:hover:text-azure-200 underline">Settings → Change password</a>. It signs them out everywhere and <span className="font-medium">won't be shown again</span>.
            </p>
