...
const AdminConsole = {
  ...
  NAV_ICONS: Object.freeze({
    ...
    // Clipboard-document-check: E2E coverage is a generated REPORT of
    // journeys that were exercised, so a checked-off document reads truer
    // than a chart (analytics) or a runner control.
