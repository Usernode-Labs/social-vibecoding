...
export function CreditOptionsCard({ view }: { view: CreditOptionsModalView }): ReactNode {
  return (
    <div className="dc-credits-modal-card w-full max-w-lg rounded-xl bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 shadow-xl p-4 dark:shadow-none">
