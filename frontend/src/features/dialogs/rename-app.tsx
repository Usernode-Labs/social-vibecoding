    ...
    >
      <DialogCard size="sm">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-300 mb-4">
          Current app name:
          <span id="rename-current" className="font-mono text-zinc-500 dark:text-zinc-300">
            {currentName}
          </span>
        </p>
        <form id="rename-form" className="space-y-4" onSubmit={submit}>
          ...
          <div id="rename-error" ref={errorRef} className="text-red-700 dark:text-red-300 text-sm hidden">
            {error}
          </div>
