...
(function () {
  ...
  async function start(opts = {}) {
    ...
    try {
      ...
      confirmBtn.style.cssText = 'width:36px;height:36px;border-radius:9999px;border:none;background:#7c3aed;color:#fff;font-size:18px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.5);';
