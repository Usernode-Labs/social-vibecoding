...
function MessageAvatar({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex w-fit min-w-8 shrink-0 items-center justify-center self-end overflow-hidden rounded-full bg-muted has-[>[data-slot=platform-icon]]:min-h-8 group-has-data-[slot=message-footer]/message:-translate-y-8 [&>[data-slot=platform-icon]]:size-4!",
        className
      )}
      {...props}
    />
