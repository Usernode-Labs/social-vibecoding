...
export function StackedTitle({
  ...
  return (
    <div className={cn('min-w-0 text-center', className)} {...props}>
      ...
      {subtitle ? (
        <div className="truncate text-[1.0625rem] text-zinc-400 dark:text-zinc-500">{subtitle}</div>
      ) : null}
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0">
        ...
        {subtitle ? (
          <span className="block truncate text-[0.9375rem] leading-tight text-zinc-400 dark:text-zinc-500">
            {subtitle}
          </span>
        ) : null}
      </span>
