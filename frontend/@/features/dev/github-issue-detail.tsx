  ...
  return <div className="isolate flex w-full flex-1 flex-col gap-6 px-4 py-8 antialiased sm:px-6" data-testid="github-issue-detail">
    ...
    <Card>
      ...
      <CardFooter className="flex flex-wrap gap-2">
        ...
        {headless?.status === "ready" && headless.mySessionId ? <ActionLink size="sm" to={appDevSessionPath(slug, headless.mySessionId)} variant="outline"><PlatformIcon data-icon="inline-start" icon={Bot} />Go to my session</ActionLink> : null}
        ...
        {closeProposal ? <ActionLink size="sm" to={appDevGovernancePath(slug, closeProposal.id)} variant="outline"><PlatformIcon data-icon="inline-start" icon={Vote} />Close proposed</ActionLink> : null}
        {issue.htmlUrl ? <ActionAnchor href={issue.htmlUrl} rel="noreferrer" size="sm" target="_blank"><PlatformIcon data-icon="inline-start" icon={ExternalLink} />View on GitHub</ActionAnchor> : null}
      </CardFooter>
    </Card>
