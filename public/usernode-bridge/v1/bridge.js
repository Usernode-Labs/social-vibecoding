...
(function () {
  ...
  //   name, url, icon_url, icon_url_dark, identity, silent }) asks the app
  // to add a homescreen entry that reopens `url` inside the Usernode app.
  // The app shows its own native confirmation UI. Resolves the app's result
