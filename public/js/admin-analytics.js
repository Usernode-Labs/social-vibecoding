...
const AdminAnalytics = (() => {
  ...
  async function loadAll() {
    const [overview, spend, growth, retention, generalUsers, powerUsers, topUsers, kudos, spendByBuilder, spendDistribution, estimator, limits] =
      await Promise.all([
        ...
        // #891: estimator accuracy. Tolerated like /limits below — this card
        // is new, so a server that predates it must not blank the whole page.
        getJSON(withAdmins('/api/admin/analytics/estimator')).catch(() => null),
