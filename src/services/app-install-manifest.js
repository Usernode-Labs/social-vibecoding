...
const PLATFORM_ICONS = Object.freeze([
  Object.freeze({ src: '/icons/v3/icon-192.png', sizes: '192x192', type: 'image/png', purpose: 'any' }),
  Object.freeze({ src: '/icons/v3/icon-512.png', sizes: '512x512', type: 'image/png', purpose: 'any' }),
  Object.freeze({ src: '/icons/v3/icon-maskable-512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' }),
]);
...
function renderSignInPage(slug) {
  ...
  <div class="icon"><img src="/icons/v3/icon-192.png" alt="" draggable="false"></div>
