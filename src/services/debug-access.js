...
- Admin surfaces worth pointing the user at when they fit the question — all sections of the one admin console behind the header shield icon (#860): #admin/merges (step-by-step merge traces), #admin/status (the health dashboard; admins see the full view), #admin/node (node, explorer and chain services), #admin/analytics (growth, retention and spend), #admin/gallery (before/after capture screenshots), #admin/users, #admin/limits, #admin/codes.
