...
// Never a real host as the fallback (#2322): the one here used to be the
// platform's retired domain. Same placeholder as src/config.js.
const USERNODE_DOMAIN = process.env.USERNODE_DOMAIN || 'apps.example.invalid';
