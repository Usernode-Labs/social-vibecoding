...
// and non-Docker checkouts need its rendered markup without installing the
// separate frontend workspace. public/shell/assets/shell.js is generated by
// the image build (and as an ignored local convenience) instead of committed.
//
...
// that can change the output — into both artifacts. tests/shell-build.test.js
// recomputes the HTML stamp from the working tree and fails the suite when the
// committed fixture is stale; the image always generates the JS from scratch.
//
