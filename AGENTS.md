...
For React UI work, read `agent-skills/ui-development/SKILL.md`. For harness
work, read `agent-skills/harness-fitness/SKILL.md`. Run
...
Begin UI or Usernode API work with
`node tool/ui-workflow.mjs --task "<task>"`; it provides
