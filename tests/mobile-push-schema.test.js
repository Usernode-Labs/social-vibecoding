...
test('closed database kind registry matches the reviewed service mapping and defaults', () => {
  ...
  // weekly_digest); 29 → 30: #2387's thread_reply. The deepEqual above is
  // the real assertion; this count is the guard against the seed and the
  // service policy drifting by an equal-and-opposite edit that leaves both
