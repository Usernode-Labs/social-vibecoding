...
test('pool bounds come from env with sane defaults and a hard ceiling', () => {
  ...
  // 490000, moved with MAX_DECLARED_TESTS 480 → 500 and the
  // platform-side default in services/visuals.js. The three are asserted
  ...
  assert.equal(testsDeadlineMs({}), 490000);
