...
test('the declared checks that read a board card’s anatomy run with the cards open; two pin the fold', () => {
  ...
  //
  // +2 (#2799, #2806): the platform's own Workshop shows no close button, and
  // an app's Workshop is the platform surface its header frosts over. 742
  // leaves 28 slots under the 770 ceiling.
