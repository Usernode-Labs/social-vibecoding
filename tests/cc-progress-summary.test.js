...
test('summarizeCcProgress: maps phase markers to friendly labels', () => {
  ...
  assert.equal(summarizeCcProgress(['[codex (mode build)]']).currentLabel, 'Coding agent is working');
  assert.equal(summarizeCcProgress(['[codex (resume thr-0199, mode scout)]']).currentLabel, 'Coding agent is working');
