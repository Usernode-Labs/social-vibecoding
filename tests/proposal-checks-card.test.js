...
test('a superseded base on a CONFLICTING head says the resolution re-runs the checks', () => {
  ...
  assert.match(note, /4 commits ago, and this proposal now conflicts with main/);
  ...
  assert.match(tag.detail, /^The checks passed, but ran against main as it was 4 commits ago\./);
});
