...
test('the budget is big enough for a full manifest at measured speed', () => {
  ...
  // ceiling — 830 now (810, 790, 770, 750, 730, 710, 690, 660, 630, 600, 580, 560, 530, 480 since #1417, 430, 400 since #1125)
  ...
  //
  // 660 → 690 (#2201) was the first of them: ~168s ideal, the deadline
  // unmoved. 690 → 710 (#2219) took the same offer: ~173s of ideal work over
  // the pool of 16, cleared by the unchanged 650s deadline with ~304s to
